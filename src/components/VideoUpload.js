...
const VideoUpload = () => {
    ...
    return (
        <Container>
            ...
            <StyledFileInput type="file" accept="video/*" onChange={handleVideoChange} required />
            <label htmlFor="thumbnail-upload">Thumbnail</label>
            <StyledFileInput type="file" accept="image/*" onChange={handleThumbnailChange} required />
